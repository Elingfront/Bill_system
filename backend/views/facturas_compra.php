...
<main class="main-content">
    <div class="alt-page-header">
        <div class="alt-header-content">
            <div class="alt-header-icon"><i data-lucide="shopping-bag" size="24"></i></div>
            <div>
                <h4 class="alt-header-title">Facturas de Compra</h4>
                <span class="alt-header-subtitle">ALT-CONFECCIONES · Registro de Egresos</span>
            </div>
        </div>
    ...
    <div class="filter-section shadow-sm">
        <div class="row align-items-end g-3">
            ...
            <div class="col-md-3">
                <div class="label-min">Estado de Pago</div>
            ...
            <div class="col-md-2">
                <a href="cuentas_pago.php" class="btn btn-dark btn-sm w-100 fw-bold">
                    <i data-lucide="credit-card" size="14"></i> PAGAR CUENTAS
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table class="tabla-alt" id="tablaCompras">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr class="row-factura" 
                    ...
                    data-search="<?= htmlspecialchars(strtolower($nit . ' ' . $nombre . ' fact-' . $folio)) ?>">
                    ...
                    <td class="text-end">
                        ...
                        <?php if(!$esPagada): ?>
                            <a href="cuentas_pago.php?id=<?= $f['id'] ?>" class="btn btn-link p-0 ms-2 text-vinotinto" title="Procesar Pago">
    ...
    <div class="modal-dialog modal-xl modal-xl-custom modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4" style="background-color: #fcfcfc;">
            <div class="modal-header border-0 pb-0 p-4">
                <div>
                    <h5 class="modal-title fw-bold text-dark"><i data-lucide="files" class="me-2"></i>Visor de Compras ALT</h5>
                    <p class="text-muted small mb-0">Factura Original, Soporte de Banco y Egreso</p>
                </div>

...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            <h2 class="text-vinotinto mb-4"><i data-lucide="file-plus"></i> Nueva Factura</h2>
                ...
                <div class="card-body">
                    <form id="formFactura" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            ...
                            <input type="text" name="numero_factura" class="form-control" placeholder="Ej: 20305" required>
                        </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Archivo PDF Factura</label>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-check form-switch p-3 border rounded bg-light d-flex align-items-center justify-content-between">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="pagada" id="factura_pagada" onchange="toggleCamposPago()" style="width: 3em; height: 1.5em; cursor: pointer;">
                                </div>
                            </div>
                        </div>
...
function toggleCamposPago() {
    ...
    seccionPago.style.display = checkPago.checked ? 'flex' : 'none';
    labelContable.innerText = esCompra ? "Comprobante de Egreso (PDF/IMG)" : "Recibo de Caja (PDF/IMG)";
    lucide.createIcons();
}

new TomSelect("#select-tercero", { create: false, sortField: { field: "text", direction: "asc" } });
...
document.getElementById('formFactura').addEventListener('submit', function(e) {
    ...
    Swal.fire({
        ...
        html: `<div class="logo-fill-container"><img src="${logoUrl}" class="logo-bg"><img src="${logoUrl}" id="fill-image" class="logo-fill"></div><div id="status-msg" class="loading-text"><span id="percent-text">0%</span></div>`,
        ...
        didOpen: () => {
            ...
            // Enviamos los datos al controlador sin recargar la página
            fetch('../app/Controllers/FacturaController.php', { method: 'POST', body: formData })
            .then(res => res.json())
            .then(data => {
                if(data.status === 'success') {
                    const interval = setInterval(() => {
                        ...
                        if (progress <= 0) {
                            ...
                            document.getElementById('status-msg').innerHTML = 'FACTURA GUARDADA';
                            form.reset(); // LIMPIAMOS EL FORM Y QUEDAMOS EN LA MISMA VISTA
                        } else {
